"""
Django settings for greg_test_dev_134273 project.
...
ROOT_URLCONF = 'greg_test_dev_134273.urls'
...
WSGI_APPLICATION = 'greg_test_dev_134273.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "greg_test_dev_134273 API",
    "DESCRIPTION": "API documentation for greg_test_dev_134273 App",
    "VERSION": "v1",
}
